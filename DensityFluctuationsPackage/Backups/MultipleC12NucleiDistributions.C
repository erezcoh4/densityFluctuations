...
// protons and neutrons positions
TC12nucleus * C12;
std::vector<TVector3> protons , neutrons , nucleons;
...
//        CalculateDensityAsAFunctionOfr( 10 );
        ...
        //....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
       if (DoDrawNuclei){
            TCanvas * c = plot -> CreateCanvas("C12","DivideSquare",Nnuclei);
            for (int i = 0 ; i < Nnuclei ; i++) {
